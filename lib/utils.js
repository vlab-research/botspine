...
class SpineBase {
  ...
  transformer(fn) { return new PromiseThroughStream(_messageWrapper(fn))  }
  chunkedTransformer(fn, n, timeout=1000, opts) { return new ChunkedTransformer(fn, n, timeout, opts) }
}
